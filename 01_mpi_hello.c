...
int main(int argc, char** argv) {
    ...
    // MPI_COMM_WORLD (comunicador padrão que inclui todos os processos)
...
// n processos rodando (definido na execução do programa e não da compilação)
// subgrupos de processos --> é possível estabeler comunicadores entre subgrupos, por exemplo. 
// compilar mpicc  arquivo.c -o arquivo


// aleatoriedade na execucao de processos


// MPI BARRIERS AND SYNCHRONIZATION (MPI_Barrier)
